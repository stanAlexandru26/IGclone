...
export default function ProfileUserHeader({
  ...
  return (
    <div className="mx-auto flex w-8/12  justify-center pb-10 md:justify-start md:gap-8 md:px-12 ">
      {/* Profile Image */}
      ...
      <div className="flex flex-col items-center justify-center gap-4">
        ...
        {/* Profile Counters */}
        <div className="container order-3 flex items-center justify-center gap-10 border-t-2 border-b-2 py-2 md:order-2 md:border-0 md:py-0 ">
